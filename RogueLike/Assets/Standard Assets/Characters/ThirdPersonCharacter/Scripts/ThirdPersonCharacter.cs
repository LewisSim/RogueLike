...
namespace UnityStandardAssets.Characters.ThirdPerson
{
	...
	public class ThirdPersonCharacter : MonoBehaviour
	{
        ...
        public void Move(Vector3 move, bool crouch, bool jump)
		{
            ...
            if (move.z != 0 )//&& TouchingGround == true)//&& IsGrounded == false)//  // if on ground, produce footprints
            {
        ...
        private void OnCollisionEnter(Collision collision) // AM I TOUCHING THE GROUND OR NOT
        {
        ...
        private void OnCollisionExit(Collision collision) /// AM I TOUCHING THE GROUND OR NOT
        {
            if (collision.gameObject.name == "floor")
            {
        ...
        private void SpawnDecal(GameObject prefab)
        {
            ...
            Vector3 to = new Vector3(this.transform.position.x, this.transform.position.y - (this.transform.localScale.y / 2.0f) + 0.3f, this.transform.position.z);
